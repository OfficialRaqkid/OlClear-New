                ...
                @foreach ($requests as $key => $req)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @else
                                {{-- ACCEPT --}}
                                <form action="{{ route('vp_sas.clearances.accept', $req->id) }}"
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    $('#holdModal').on('show.bs.modal', function (event) {
        ...
        document.getElementById('holdForm').action = "/vp_sas/clearance-requests/" + id + "/hold";
    });
    ...
    $('#viewModal').on('show.bs.modal', function (event) {
        ...
        document.getElementById('viewSignForm').action = "/vp_sas/clearance-requests/" + id + "/accept";
    });
