<x-master-layout  
    :breadcrumbs="['Registrar', 'Clearance Requests']"
...
<div class="az-dashboard-one-title mb-4">
    <div>
        <h2 class="az-dashboard-title">Clearance Requests</h2>
                ...
                @foreach ($requests as $key => $req)
                    ...
                    <td class="text-center">
                        ...
                        @else
                            {{-- APPROVE --}}
                            <form
                                action="{{ route('registrar.clearances.accept', $req->id) }}"
                                method="POST"
                                class="d-inline">
                                @csrf
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    $('#viewModal').on('show.bs.modal', function (event) {
        ...
        document.getElementById('viewApproveForm').action =
            "/registrar/clearances/" + id + "/approve";
    });
