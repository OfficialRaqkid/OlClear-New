                ...
                @foreach ($requests as $key => $req)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @else
                                {{-- ACCEPT BUTTON --}}
                                <form action="{{ route('dean.clearance_requests.accept', $req->id) }}" method="POST" class="d-inline">
                                    @csrf
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    $('#holdModal').on('show.bs.modal', function (event) {
        ...
        document.getElementById('holdForm').action = "/dean/clearance-requests/" + id + "/hold";
    });
    ...
    $('#viewModal').on('show.bs.modal', function (event) {
        ...
        document.getElementById('viewSignForm').action = "/dean/clearance-requests/" + id + "/accept";
    });
