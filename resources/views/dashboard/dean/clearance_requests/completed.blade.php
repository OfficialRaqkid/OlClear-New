<x-master-layout  
    :breadcrumbs="['Department Office', 'Completed Departmental Clearances']"
...
<div class="card shadow-sm border-0">
    <div class="card-body p-0">
        @php
            $departmentalCompleted = $completedRequests->filter(function ($req) {
                return optional($req->clearance->clearanceType)->name === 'Departmental Clearance';
            });
        @endphp

        @if ($departmentalCompleted->isEmpty())
            <div class="text-center py-5 text-muted">
                No completed departmental clearances found.
            </div>
        @else
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                @foreach ($departmentalCompleted as $req)
                    <tr>
